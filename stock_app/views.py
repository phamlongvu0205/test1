...
import io
# Thêm đường dẫn tới file finance_df.py
sys.path.append(str(Path(r"/Users/phamlongvu/Documents/programs/vscode/finance_py")))
sys.path.append(str(Path(r"/Users/phamlongvu/Documents/programs/vscode/finance_py/venv/lib/python3.12/site-packages")))
# Import hàm price_stock từ file finance_df.py
from finance_df import *
